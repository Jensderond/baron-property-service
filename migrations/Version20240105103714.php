 ...
 */
final class Version20240105103714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, external_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, description_site LONGTEXT DEFAULT NULL, city VARCHAR(255) NOT NULL, zipcode VARCHAR(20) NOT NULL, province VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, category VARCHAR(255) NOT NULL, diversen JSON NOT NULL COMMENT \'(DC2Type:json)\', algemeen JSON NOT NULL COMMENT \'(DC2Type:json)\', slug VARCHAR(255) NOT NULL, media JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', living_area VARCHAR(255) NOT NULL, main_image JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', plot VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, algemeen JSON NOT NULL COMMENT \'(DC2Type:json)\', financieel JSON NOT NULL COMMENT \'(DC2Type:json)\', teksten JSON NOT NULL COMMENT \'(DC2Type:json)\', status VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, house_number INT DEFAULT NULL, house_number_addition VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, zip VARCHAR(255) DEFAULT NULL, lat VARCHAR(255) DEFAULT NULL, lng VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, external_id INT NOT NULL, street VARCHAR(255) DEFAULT NULL, archived TINYINT(1) DEFAULT NULL, build_year INT DEFAULT NULL, price INT DEFAULT NULL, rental_price INT DEFAULT NULL, energy_class VARCHAR(25) DEFAULT NULL, image JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', media JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', etages JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', overig_onroerend_goed JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', buitenruimte JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
