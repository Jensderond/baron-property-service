...
#[AsCommand(
    name: 'app:set-property-location',
    description: 'Set latitude and longitude for a property object',
)]
class SetPropertyLocationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $selectedObject = $this->propertyRepository->findOneBy(['title' => $selectedObjectName]);
